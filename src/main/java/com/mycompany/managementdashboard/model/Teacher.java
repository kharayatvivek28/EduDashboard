...
public class Teacher {
    ...
    public Teacher() {}
    public Teacher(int teacherId, String username, String fname, String lname, String email, String password) {
    ...
    public void setTeacherDetails(TeacherDetails teacherDetails) {
        ...
        if (teacherDetails != null) {
            teacherDetails.setTeacher(this); // Bidirectional setting
        }
    }
